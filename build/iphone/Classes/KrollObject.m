 ...
 * Copyright (c) 2009-2011 by Basewaterapp, Inc. All Rights Reserved.
...
//@interface BasewaterappObject : NSObject
//@end

@interface BasewaterappObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[BasewaterappObject class]])
		{
			for (NSString *key in [[(BasewaterappObject*)o modules] allKeys])
			{
