...
@interface BasewaterappObject : KrollCoverageObject {
#else
@interface BasewaterappObject : KrollObject {
#endif
@private
...
extern NSString * Basewaterapp$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	BasewaterappObject *_basewaterapp;
	BOOL shutdown;
