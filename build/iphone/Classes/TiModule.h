...
/**
 The base class for all Basewaterapp modules
 */
...
/**
 Basewaterapp Platform calls this method on startup.
 */
-(void)startup;

/**
 Basewaterapp Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Basewaterapp Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Basewaterapp Platform calls this method on resume.
 @param sender The sender of the event.
 */
