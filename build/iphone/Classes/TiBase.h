...
// in simulator we redefine to format for Basewaterapp Developer console
...
{\
	NSString * exceptionName = [@"org.basewaterapp." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.basewaterapp";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIBasewaterappNativeItemNone = -1, 
	UIBasewaterappNativeItemSpinner = -2,
	UIBasewaterappNativeItemProgressBar = -3,
	
	UIBasewaterappNativeItemSlider = -4,
	UIBasewaterappNativeItemSwitch = -5,
	UIBasewaterappNativeItemMultiButton = -6,
	UIBasewaterappNativeItemSegmented = -7,
	
	UIBasewaterappNativeItemTextView = -8,
	UIBasewaterappNativeItemTextField = -9,
	UIBasewaterappNativeItemSearchBar = -10,
	
	UIBasewaterappNativeItemPicker = -11,
	UIBasewaterappNativeItemDatePicker = -12,
	
	UIBasewaterappNativeItemInfoLight = -13,
	UIBasewaterappNativeItemInfoDark = -14,
	
	UIBasewaterappNativeItemDisclosure = -15,
	
	UIBasewaterappNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Basewaterapp instances of
