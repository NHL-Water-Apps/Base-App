...
//Rare exceptions to indicate a bug in the _basewaterapp code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Basewaterapp proxies.
 */
